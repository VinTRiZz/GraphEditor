...
void ApplicationSettings::loadSettings(const QString &configPath) {
  ...
  for (const auto &recentFile :
       settings.value("recent_open_files", "").toString().split(",")) {
...
ApplicationSettingsHelper::GeneralConfiguration &
ApplicationSettings::getGeneralConfig() {
  return m_generalConfig;
}

ApplicationSettingsHelper::ObjectsConfiguration &
ApplicationSettings::getObjectsConfig() {
  return m_objectsConfig;
}

ApplicationSettingsHelper::CanvasConfiguration &
ApplicationSettings::getCanvasConfig() {
...
void ApplicationSettings::clearRecentFiles() { m_recentFiles.clear(); }
