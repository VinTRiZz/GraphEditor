...
int CanvasConfiguration::getGridSize() const {
    return m_gridSize;
}
...
void CanvasConfiguration::setGridSize(int size) {
    m_gridSize = size;
}
...
ObjectsConfiguration::NodeShape ObjectsConfiguration::getDefaultNodeShape()
    const {
