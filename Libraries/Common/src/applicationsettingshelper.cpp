...
GeneralConfiguration::stringToTheme(const QString &str) const {
  if (str == "Light")
    return Theme::Light;
  if (str == "Dark")
    return Theme::Dark;
...
void GeneralConfiguration::setThemeType(Theme theme) { m_themeType = theme; }
...
QSize CanvasConfiguration::getCanvasSize() const { return m_canvasSize; }

int CanvasConfiguration::getCanvasOpacity() const { return m_canvasOpacity; }

QColor CanvasConfiguration::getBackgroundColor() const {
  return m_backgroundColor;
}

QColor CanvasConfiguration::getGridColor() const { return m_gridColor; }

bool CanvasConfiguration::getIsGridEnabled() const { return m_isGridEnabled; }

int CanvasConfiguration::getGridSize() const { return m_gridSize; }

double CanvasConfiguration::getGridLineWidth() const { return m_gridLineWidth; }
...
void CanvasConfiguration::setGridColor(const QColor &col) { m_gridColor = col; }

void CanvasConfiguration::setIsGridEnabled(bool hasGrid) {
  m_isGridEnabled = hasGrid;
}

void CanvasConfiguration::setGridSize(int size) { m_gridSize = size; }
...
QColor CanvasConfiguration::getCanvasColor() const { return m_canvasColor; }
...
ObjectsConfiguration::NodeShape
ObjectsConfiguration::getDefaultNodeShape() const {
...
int ObjectsConfiguration::getLineThickness() const { return m_lineThickness; }
...
void ObjectsConfiguration::setNodeSize(NodeSize size) { m_nodeSize = size; }
