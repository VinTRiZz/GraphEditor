...
GraphEditorSettingsForm::~GraphEditorSettingsForm() { delete ui; }
...
void GraphEditorSettingsForm::setCanvasSizeType(int sizesTypeInt) {
  ...
  case MultiplyCoeffType::Screen:
    ui->spinBox_width->setValue(isAlbumOrientation ? m_screenSize.height()
                                                   : m_screenSize.width());
    m_widthMultiplyCoefficient = static_cast<double>(m_screenSize.height()) /
