...
GraphTabWidget::GraphTabWidget(QWidget *parent)
  ...
  connect(ui->editorForms_tabWidget, &QTabWidget::currentChanged, this,
          [this](int tabIndex) {
            ...
            connect(ui->filesToolBar, &GraphFilesToolbar::showProperties, pForm,
                    &GraphEditorForm::showGraphProperties);
            connect(ui->filesToolBar, &GraphFilesToolbar::hideProperties, pForm,
                    &GraphEditorForm::hideGraphProperties);
          });
...
GraphTabWidget::~GraphTabWidget() { delete ui; }
