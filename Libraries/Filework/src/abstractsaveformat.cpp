...
AbstractSaveFormat::AbstractSaveFormat(const QString &formatVersion,
    ...
    : m_formatVersion(formatVersion), m_formatExtension(formatExtension),
...
QString AbstractSaveFormat::getExtension() const { return m_formatExtension; }

QString AbstractSaveFormat::getDescription() const {
  return m_formatDescription;
}

QString AbstractSaveFormat::getVersion() const { return m_formatVersion; }
