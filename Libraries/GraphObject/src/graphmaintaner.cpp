...
GraphObject &GraphMaintainer::getObject() { return m_graph; }

GraphExtendedObject *GraphMaintainer::getExtendedObject() { return &m_graph; }
...
QString GraphMaintainer::getName() const { return m_name; }
...
QString GraphMaintainer::getDescription() const { return m_description; }
...
QDateTime GraphMaintainer::getCreateTime() const { return m_createTime; }
...
QDateTime GraphMaintainer::getEditTime() const { return m_editTime; }
...
GraphMaintainer::getCustomValueMapRef() const {
  return m_customDataValues;
}
