...
VertexObject *VertexConnectionLine::getVertexTo() const { return m_toVertex; }
...
QLineF VertexConnectionLine::getLine() const { return m_straightLine; }
...
void VertexConnectionLine::setArrowSize(qreal size) { m_arrowSize = size; }

qreal VertexConnectionLine::getArrowSize() const { return m_arrowSize; }
...
void VertexConnectionLine::updatePolygon() {
  ...
  m_boundingRect.setWidth(std::fabs(m_straightLine.x2() - m_straightLine.x1()) +
                          m_arrowSize * 2);
...
QRectF VertexConnectionLine::boundingRect() const { return m_boundingRect; }
