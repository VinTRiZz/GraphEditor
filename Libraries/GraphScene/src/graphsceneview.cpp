...
ObjectViewItems::VertexConnectionLine *
GraphSceneView::createConnectionLine(ObjectViewConstants::objectId_t idFrom,
...
GraphSceneView::createVertex(ObjectViewConstants::objectId_t vId) {
