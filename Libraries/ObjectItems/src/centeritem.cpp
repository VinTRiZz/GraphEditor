...
CenterItem::CenterItem(ItemBase* parent) :
    ItemBase(parent) {
    ...
    m_pCenterEllipse->setRect(QRectF(maxX / 2.0 - centerSizeX / 2.0, maxY / 2.0 - centerSizeY / 2.0, centerSizeX, centerSizeY));
    ...
    m_pCenterTargetEllipse->setRect(QRectF(maxX * (1 - roundEllipseScale) * 0.5, maxY * (1 - roundEllipseScale) * 0.5,
