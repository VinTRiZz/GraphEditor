...
PictureObjectItem::PictureObjectItem(QGraphicsItem *parent) : ItemBase(parent) {
  ...
  PictureObjectItem::setMainColor(appSettings.getObjectsConfig().getNodeMainColor());
...
LabelItem *PictureObjectItem::getLabel() const { return m_nameItem; }
...
QRectF PictureObjectItem::getImageRect() const { return m_vertexEllipse->rect(); }
...
QVariant PictureObjectItem::itemChange(GraphicsItemChange change, const QVariant &value)
{
