...
void SceneMarkerItem::setTarget(QGraphicsItem *pTarget) { m_pTarget = pTarget; }

QGraphicsItem *SceneMarkerItem::getTarget() const { return m_pTarget; }

void SceneMarkerItem::setTargetIcon(const QImage &targetImage) {
  m_targetImage = targetImage;
}

void SceneMarkerItem::paint(QPainter *painter,
...
QVariant SceneMarkerItem::itemChange(GraphicsItemChange change,
