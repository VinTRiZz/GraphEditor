...
bool ObjectsInternalScene::getIsGridEnabled() const { return m_isGridEnabled; }
...
int ObjectsInternalScene::getGridSize() const { return m_baseGridSize; }
...
void ObjectsInternalScene::resetGridPen() {
  m_gridPen = {QColor(15, 90, 180, 100), 2};
  update(sceneRect());
}
